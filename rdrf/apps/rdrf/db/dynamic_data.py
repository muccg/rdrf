...
from rdrf.apps.rdrf.forms.file_upload import FileUpload, wrap_fs_data_for_form
from rdrf.apps.rdrf.models.definition.models import Registry, ClinicalData
from rdrf.apps.rdrf.helpers.utils import get_code, models_from_mongo_key, is_delimited_key, mongo_key, is_multisection
from rdrf.apps.rdrf.helpers.utils import is_file_cde, is_multiple_file_cde, is_uploaded_file
    ...
    def _get_section_dict(self, form_model, section_model, data):
        ...
        for section_dict in form_dict["sections"]:
            if section_dict["code"] == section_model.code:
                return section_dict
        section_dict = {"code": section_model.code, "cdes": [],

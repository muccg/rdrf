...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='registry',
            field=models.ForeignKey(to='rdrf.Registry', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='customuser',
            name='registry',
            field=models.ManyToManyField(related_name='registry', to='rdrf.Registry'),
        ),
        migrations.AddField(
            model_name='customuser',
        ...
        migrations.AddField(
            model_name='customuser',
            name='working_groups',
            field=models.ManyToManyField(related_name='working_groups', null=True, to='groups.WorkingGroup'),
        ),
    ]

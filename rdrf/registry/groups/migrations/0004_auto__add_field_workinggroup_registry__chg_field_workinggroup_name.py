...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'WorkingGroup.name'
        db.alter_column(u'groups_workinggroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Changing field 'WorkingGroup.name'
        db.alter_column(u'groups_workinggroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

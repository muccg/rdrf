...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConsentValue'
        db.create_table(u'patients_consentvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.Patient'])),
            ('consent_question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rdrf.ConsentQuestion'])),
        ))
        db.send_create_signal(u'patients', ['ConsentValue'])


    def backwards(self, orm):
        # Deleting model 'ConsentValue'
        db.delete_table(u'patients_consentvalue')
    ...
    models = {
        ...
        u'patients.patient': {
            ...
            'consent_json': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),

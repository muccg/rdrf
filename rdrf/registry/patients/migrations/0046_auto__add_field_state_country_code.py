...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.country_code'
        db.add_column(u'patients_state', 'country_code',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.country_code'
        db.delete_column(u'patients_state', 'country_code')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PatientAddress.suburb'
        db.alter_column(u'patients_patientaddress', 'suburb', self.gf('django.db.models.fields.CharField')(max_length=100))
        ...
        # Changing field 'PatientAddress.postcode'
        db.alter_column(u'patients_patientaddress', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PatientAddress.suburb'
        db.alter_column(u'patients_patientaddress', 'suburb', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'PatientAddress.state'
        db.alter_column(u'patients_patientaddress', 'state', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'PatientAddress.postcode'
        db.alter_column(u'patients_patientaddress', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=20))

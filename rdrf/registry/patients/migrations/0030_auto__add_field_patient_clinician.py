...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.clinician'
        db.add_column(u'patients_patient', 'clinician',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.CustomUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.clinician'
        db.delete_column(u'patients_patient', 'clinician_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.consent_clinical_trials'
        db.add_column(u'patients_patient', 'consent_clinical_trials',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Patient.consent_sent_information'
        db.add_column(u'patients_patient', 'consent_sent_information',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.consent_clinical_trials'
        db.delete_column(u'patients_patient', 'consent_clinical_trials')

        # Deleting field 'Patient.consent_sent_information'
        db.delete_column(u'patients_patient', 'consent_sent_information')

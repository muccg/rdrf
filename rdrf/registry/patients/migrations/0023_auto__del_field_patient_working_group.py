...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Patient.working_group'
        db.delete_column(u'patients_patient', 'working_group_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Patient.working_group'
        raise RuntimeError("Cannot reverse this migration. 'Patient.working_group' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Patient.working_group'
        db.add_column(u'patients_patient', 'working_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.WorkingGroup']),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.maiden_name'
        db.add_column(u'patients_patient', 'maiden_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.maiden_name'
        db.delete_column(u'patients_patient', 'maiden_name')

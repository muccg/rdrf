...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Patient.consent_json'
        db.delete_column(u'patients_patient', 'consent_json')


    def backwards(self, orm):
        # Adding field 'Patient.consent_json'
        db.add_column(u'patients_patient', 'consent_json',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'patients_patient', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_object', null=True, to=orm['groups.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.user'
        db.delete_column(u'patients_patient', 'user_id')

...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for patient in orm.Patient.objects.all():
            ...
            try:
                patient.save()
                print "Patient %s sex updated OK ( %s -> %s)" % (patient.pk, old_sex_value, new_sex_value)
            except ValidationError, vex:
                print "Patient %s failed to update: %s" % (patient.pk, vex)
    ...
    def backwards(self, orm):
        for patient in orm.Patient.objects.all():
            ...
            try:
                patient.save()
                print "Patient %s sex changed back OK ( %s -> %s)" % (patient.pk, old_sex_value, new_sex_value)
            except ValidationError, vex:
                print "Patient %s failed to change back sex: %s" % (patient.pk, vex)

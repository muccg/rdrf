...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.next_of_kin_relationship'
        db.alter_column(u'patients_patient', 'next_of_kin_relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.NextOfKinRelationship'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Patient.next_of_kin_state'
        db.alter_column(u'patients_patient', 'next_of_kin_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['patients.State']))

        # Changing field 'Patient.user'
        db.alter_column(u'patients_patient', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['groups.CustomUser']))
        # Adding field 'ConsentValue.first_save'
        db.add_column(u'patients_consentvalue', 'first_save',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConsentValue.last_update'
        db.add_column(u'patients_consentvalue', 'last_update',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Patient.next_of_kin_relationship'
        db.alter_column(u'patients_patient', 'next_of_kin_relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.NextOfKinRelationship'], null=True))

        # Changing field 'Patient.next_of_kin_state'
        db.alter_column(u'patients_patient', 'next_of_kin_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['patients.State']))

        # Changing field 'Patient.user'
        db.alter_column(u'patients_patient', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['groups.CustomUser']))
        # Deleting field 'ConsentValue.first_save'
        db.delete_column(u'patients_consentvalue', 'first_save')

        # Deleting field 'ConsentValue.last_update'
        db.delete_column(u'patients_consentvalue', 'last_update')

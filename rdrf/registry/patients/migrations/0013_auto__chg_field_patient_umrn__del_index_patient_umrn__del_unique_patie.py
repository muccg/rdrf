...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Patient', fields ['umrn']
        db.delete_unique('patients_patient', ['umrn'])


        # Changing field 'Patient.umrn'
        db.alter_column('patients_patient', 'umrn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Patient.umrn'
        raise RuntimeError("Cannot reverse this migration. 'Patient.umrn' and its values cannot be restored.")
        # Adding unique constraint on 'Patient', fields ['umrn']
        db.create_unique('patients_patient', ['umrn'])

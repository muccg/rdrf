...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsentValue.answer'
        db.add_column(u'patients_consentvalue', 'answer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsentValue.answer'
        db.delete_column(u'patients_consentvalue', 'answer')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParentGuardian.user'
        db.add_column(u'patients_parentguardian', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_user_object', null=True, on_delete=models.SET_NULL, to=orm['groups.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParentGuardian.user'
        db.delete_column(u'patients_parentguardian', 'user_id')

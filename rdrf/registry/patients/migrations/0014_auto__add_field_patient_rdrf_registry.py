...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.rdrf_registry'
        db.add_column(u'patients_patient', 'rdrf_registry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rdrf.Registry']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.rdrf_registry'
        db.delete_column(u'patients_patient', 'rdrf_registry_id')

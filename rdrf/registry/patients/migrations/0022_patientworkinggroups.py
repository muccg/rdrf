...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for patient_model in orm['patients.Patient'].objects.all():
            existing_workgroup = patient_model.working_group
            patient_model.working_groups = [existing_workgroup]
            patient_model.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for patient_model in orm['patients.Patient'].objects.all():
            patient_model.working_groups = []
            patient_model.save()

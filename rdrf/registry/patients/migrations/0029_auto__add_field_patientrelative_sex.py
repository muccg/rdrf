...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRelative.sex'
        db.add_column(u'patients_patientrelative', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRelative.sex'
        db.delete_column(u'patients_patientrelative', 'sex')

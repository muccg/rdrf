...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRelative.relative_patient'
        db.add_column(u'patients_patientrelative', 'relative_patient',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='as_a_relative', unique=True, null=True, to=orm['patients.Patient']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRelative.relative_patient'
        db.delete_column(u'patients_patientrelative', 'relative_patient_id')
    ...
    models = {
        ...
        u'patients.patientrelative': {
            ...
            'relative_patient': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'as_a_relative'", 'unique': 'True', 'null': 'True', 'to': u"orm['patients.Patient']"})
        },
        u'patients.state': {

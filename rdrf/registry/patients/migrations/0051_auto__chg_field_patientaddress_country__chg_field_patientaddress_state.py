...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'patients_patientaddress', 'country', self.gf('django.db.models.fields.CharField')(default='AU', max_length=100))

        # Changing field 'PatientAddress.state'
        db.alter_column(u'patients_patientaddress', 'state', self.gf('django.db.models.fields.CharField')(default='WA', max_length=50))

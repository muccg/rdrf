...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PatientRelative.date_of_birth'
        db.alter_column(u'patients_patientrelative', 'date_of_birth', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 11, 21, 0, 0)))

    def backwards(self, orm):

        # Changing field 'PatientRelative.date_of_birth'
        db.alter_column(u'patients_patientrelative', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True))

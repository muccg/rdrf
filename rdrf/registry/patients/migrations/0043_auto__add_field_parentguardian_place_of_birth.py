...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParentGuardian.place_of_birth'
        db.add_column(u'patients_parentguardian', 'place_of_birth',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParentGuardian.place_of_birth'
        db.delete_column(u'patients_parentguardian', 'place_of_birth')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PatientRelative'
        db.create_table(u'patients_patientrelative', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.Patient'])),
            ('relationship', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('living_status', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal(u'patients', ['PatientRelative'])


    def backwards(self, orm):
        # Deleting model 'PatientRelative'
        db.delete_table(u'patients_patientrelative')

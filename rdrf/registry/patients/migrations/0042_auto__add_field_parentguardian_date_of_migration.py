...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParentGuardian.date_of_migration'
        db.add_column(u'patients_parentguardian', 'date_of_migration',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParentGuardian.date_of_migration'
        db.delete_column(u'patients_parentguardian', 'date_of_migration')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field working_groups on 'Patient'
        m2m_table_name = db.shorten_name(u'patients_patient_working_groups')
        ...
        db.create_unique(m2m_table_name, ['patient_id', 'workinggroup_id'])


    def backwards(self, orm):
        # Removing M2M table for field working_groups on 'Patient'
        db.delete_table(db.shorten_name(u'patients_patient_working_groups'))

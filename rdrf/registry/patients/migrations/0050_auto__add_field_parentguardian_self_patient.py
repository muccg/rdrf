...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParentGuardian.self_patient'
        db.add_column(u'patients_parentguardian', 'self_patient',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='self_patient', null=True, to=orm['patients.Patient']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParentGuardian.self_patient'
        db.delete_column(u'patients_parentguardian', 'self_patient_id')
    ...
    models = {
        ...
        u'patients.parentguardian': {
            ...
            'self_patient': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'self_patient'", 'null': 'True', 'to': u"orm['patients.Patient']"}),
        ...
        u'rdrf.consentquestion': {
            ...
            'questionnaire_label': ('django.db.models.fields.TextField', [], {'blank': 'True'}),

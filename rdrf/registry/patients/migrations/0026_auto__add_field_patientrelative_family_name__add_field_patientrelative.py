...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRelative.family_name'
        db.add_column(u'patients_patientrelative', 'family_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PatientRelative.given_names'
        db.add_column(u'patients_patientrelative', 'given_names',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRelative.family_name'
        db.delete_column(u'patients_patientrelative', 'family_name')

        # Deleting field 'PatientRelative.given_names'
        db.delete_column(u'patients_patientrelative', 'given_names')
    ...
    models = {
        ...
        u'patients.patientrelative': {
            ...
            'given_names': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

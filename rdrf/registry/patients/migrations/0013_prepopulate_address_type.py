...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        address1 = orm['patients.AddressType'].objects.get_or_create(pk=1,type='Home',description='Home address')
        address2 = orm['patients.AddressType'].objects.get_or_create(pk=2,type='Postal',description='Postal address')

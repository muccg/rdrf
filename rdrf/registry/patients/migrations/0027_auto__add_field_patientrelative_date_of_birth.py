...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientRelative.date_of_birth'
        db.add_column(u'patients_patientrelative', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatientRelative.date_of_birth'
        db.delete_column(u'patients_patientrelative', 'date_of_birth')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.consent_provided_by_parent_guardian'
        db.add_column(u'patients_patient', 'consent_provided_by_parent_guardian',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.consent_provided_by_parent_guardian'
        db.delete_column(u'patients_patient', 'consent_provided_by_parent_guardian')

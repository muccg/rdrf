...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PatientAddress.address_type'
        db.delete_column(u'patients_patientaddress', 'address_type')

        # Adding field 'PatientAddress.type'
        db.add_column(u'patients_patientaddress', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['patients.AddressType']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PatientAddress.address_type'
        raise RuntimeError("Cannot reverse this migration. 'PatientAddress.address_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PatientAddress.address_type'
        db.add_column(u'patients_patientaddress', 'address_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50),
                      keep_default=False)

        # Deleting field 'PatientAddress.type'
        db.delete_column(u'patients_patientaddress', 'type_id')
    ...
    models = {
        ...
        u'patients.patientaddress': {
            ...
            'suburb': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['patients.AddressType']"})
        },

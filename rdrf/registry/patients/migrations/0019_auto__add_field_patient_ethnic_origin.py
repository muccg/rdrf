...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.ethnic_origin'
        db.add_column(u'patients_patient', 'ethnic_origin',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.ethnic_origin'
        db.delete_column(u'patients_patient', 'ethnic_origin')

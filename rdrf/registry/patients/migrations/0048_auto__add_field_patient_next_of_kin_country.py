...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.next_of_kin_country'
        db.add_column(u'patients_patient', 'next_of_kin_country',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'Patient.next_of_kin_state' to match new field type.
        db.rename_column(u'patients_patient', 'next_of_kin_state_id', 'next_of_kin_state')
        # Changing field 'Patient.next_of_kin_state'
        db.alter_column(u'patients_patient', 'next_of_kin_state', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
        # Removing index on 'Patient', fields ['next_of_kin_state']
        db.delete_index(u'patients_patient', ['next_of_kin_state_id'])


    def backwards(self, orm):
        # Adding index on 'Patient', fields ['next_of_kin_state']
        db.create_index(u'patients_patient', ['next_of_kin_state_id'])

        # Deleting field 'Patient.next_of_kin_country'
        db.delete_column(u'patients_patient', 'next_of_kin_country')


        # Renaming column for 'Patient.next_of_kin_state' to match new field type.
        db.rename_column(u'patients_patient', 'next_of_kin_state', 'next_of_kin_state_id')
        # Changing field 'Patient.next_of_kin_state'
        db.alter_column(u'patients_patient', 'next_of_kin_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['patients.State'], on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'patients.parentguardian': {
            ...
            'suburb': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'parent_user_object'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['groups.CustomUser']"})
        },
        u'patients.patient': {
            ...
            'next_of_kin_country': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'next_of_kin_state': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'patients.state': {
            ...
            'country_code': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        u'rdrf.consentsection': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'information_link': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'validation_rule': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'rdrf.registry': {

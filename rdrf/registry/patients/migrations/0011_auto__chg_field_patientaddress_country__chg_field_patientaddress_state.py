...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'patients_patientaddress', 'country', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Renaming column for 'PatientAddress.state' to match new field type.
        db.rename_column(u'patients_patientaddress', 'state_id', 'state')
        # Changing field 'PatientAddress.state'
        db.alter_column(u'patients_patientaddress', 'state', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Removing index on 'PatientAddress', fields ['state']
        db.delete_index(u'patients_patientaddress', ['state_id'])


    def backwards(self, orm):
        # Adding index on 'PatientAddress', fields ['state']
        db.create_index(u'patients_patientaddress', ['state_id'])


        # Changing field 'PatientAddress.country'
        db.alter_column(u'patients_patientaddress', 'country', self.gf('django_countries.fields.CountryField')(max_length=2))

        # Renaming column for 'PatientAddress.state' to match new field type.
        db.rename_column(u'patients_patientaddress', 'state', 'state_id')
        # Changing field 'PatientAddress.state'
        db.alter_column(u'patients_patientaddress', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.State']))

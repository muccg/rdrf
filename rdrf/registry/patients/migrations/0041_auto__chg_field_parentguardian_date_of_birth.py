...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParentGuardian.date_of_birth'
        db.alter_column(u'patients_parentguardian', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ParentGuardian.date_of_birth'
        db.alter_column(u'patients_parentguardian', 'date_of_birth', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(1900, 1, 1, 0, 0)))

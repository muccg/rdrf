...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent', models.BooleanField(
                    help_text=b'The patient consents to be part of the registry and have data retained and shared in accordance with the information provided to them.', verbose_name=b'consent given')),
                ('consent_clinical_trials', models.BooleanField(default=False,
                                                                help_text=b'Consent given to be contacted about clinical trials or other studies related to their condition.')),
                ('consent_sent_information', models.BooleanField(default=False,
                                                                 help_text=b'Consent given to be sent information on their condition', verbose_name=b'consent to be sent information given')),
                ('consent_provided_by_parent_guardian', models.BooleanField(default=False,
                ...
                ('next_of_kin_state', models.CharField(max_length=20, null=True,
                                                       verbose_name=b'State/Province/Territory', blank=True)),
                ...
                ('next_of_kin_mobile_phone', models.CharField(max_length=30,
                                                              null=True, verbose_name=b'mobile phone', blank=True)),
                ...
                ('next_of_kin_parent_place_of_birth', models.CharField(max_length=100,
                                                                       null=True, verbose_name=b'Place of birth of parents', blank=True)),
                ...
                ('inactive_reason', models.TextField(help_text=b'Please provide reason for deactivating the patient',
                                                     null=True, verbose_name=b'Reason', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('form', models.FileField(storage=django.core.files.storage.FileSystemStorage(base_url=b'/static/media/',
                                                                                              location=b'/data/static/media'), upload_to=b'consents', null=True, verbose_name=b'Consent form', blank=True)),
                ('patient', models.ForeignKey(to='patients.Patient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField()),
                ('sex', models.CharField(max_length=1, choices=[
                 (b'M', b'Male'), (b'F', b'Female'), (b'X', b'Other/Intersex')])),
                ('relationship', models.CharField(max_length=80, choices=[(b'Parent', b'Parent'), (b'Sibling', b'Sibling'), (b'Child', b'Child'), (b'Identical Twin', b'Identical Twin'), (b'Half Sibling', b'Half Sibling'), (b'Niece/Nephew', b'Niece/Nephew'), (b'1st Cousin', b'1st Cousin'), (b'Grandchild', b'Grandchild'), (b'Uncle/Aunty', b'Uncle/Aunty'), (b'Spouse', b'Spouse'), (
                    b'Non-identical twin', b'Non-identical twin'), (b'Grandparent', b'Grandparent'), (b'1st cousin once removed', b'1st cousin once removed'), (b'Great Grandparent', b'Great Grandparent'), (b'Great Grandchild', b'Great Grandchild'), (b'Great Uncle/Aunt', b'Great Uncle/Aunt'), (b'Great Niece/Nephew', b'Great Niece/Nephew'), (b'Unknown', b'Unknown'), (b'Other', b'Other')])),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL,
                                    verbose_name=b'Relationship', blank=True, to='patients.NextOfKinRelationship', null=True),
        ),
    ]

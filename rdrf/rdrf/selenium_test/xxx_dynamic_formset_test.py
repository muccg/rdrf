...
class DynamicFormsetTest(Base):
    ...
    def test_dynamic_formset_add_remove(self):
        ...
        sel.select(
            "id=id_ClinicalData____DM1GeneticTestDetails____GeneticTestResultsAvailable", "label=Yes")
        sel.select(
            "id=id_ClinicalData____DM1GeneticTestDetails____HasReceivedGeneticCounselling", "label=Yes")
        sel.select(
            "id=id_ClinicalData____DM1GeneticTestDetails____FamReceivedGeneticCounselling", "label=Yes")
        ...
        sel.select(
            "id=id_ClinicalData____DM1MotorFunction____DM1BestMotorLevel", "label=Non-ambulatory")
        ...
        sel.select(
            "id=id_ClinicalData____DM1MRCScaleMuscleGrading____FlexorDigitorumProfundis", "label=1")
        sel.select(
        ...
        sel.type(
            "id=id_formset_DM1MuscleMedications-0-ClinicalData____DM1MuscleMedications____Drug", "mm1")
        sel.select("id=id_formset_DM1MuscleMedications-0-ClinicalData____DM1MuscleMedications____MuscleMedicationStatus",
                   "label=Current prescription")
        sel.click("id=add_button_for_section_DM1MuscleMedications")
        sel.type(
            "id=id_formset_DM1MuscleMedications-1-ClinicalData____DM1MuscleMedications____Drug", "mm2")
        sel.select("id=id_formset_DM1MuscleMedications-1-ClinicalData____DM1MuscleMedications____MuscleMedicationStatus",
                   "label=Previous prescription")
        sel.click("id=add_button_for_section_DM1MuscleMedications")
        sel.type(
            "id=id_formset_DM1MuscleMedications-2-ClinicalData____DM1MuscleMedications____Drug", "mm3")
        sel.select("id=id_formset_DM1MuscleMedications-2-ClinicalData____DM1MuscleMedications____MuscleMedicationStatus",
                   "label=Current prescription")
        ...
        sel.type(
            "id=id_formset_DM1HeartMedications-0-ClinicalData____DM1HeartMedications____Drug", "hm1")
        sel.select("id=id_formset_DM1HeartMedications-0-ClinicalData____DM1HeartMedications____HeartMedicationStatus",
                   "label=Current prescription")
        sel.click("id=add_button_for_section_DM1HeartMedications")
        sel.type(
            "id=id_formset_DM1HeartMedications-1-ClinicalData____DM1HeartMedications____Drug", "hm2")
        sel.select("id=id_formset_DM1HeartMedications-1-ClinicalData____DM1HeartMedications____HeartMedicationStatus",
                   "label=Previous prescription")
        sel.click("id=add_button_for_section_DM1HeartMedications")
        sel.type(
            "id=id_formset_DM1HeartMedications-2-ClinicalData____DM1HeartMedications____Drug", "hm3")
        sel.select("id=id_formset_DM1HeartMedications-2-ClinicalData____DM1HeartMedications____HeartMedicationStatus",
                   "label=Current prescription")
        sel.click("xpath=(//button[@type='button'])[7]")
        sel.click("id=add_button_for_section_DM1HeartMedications")
        sel.type(
            "id=id_formset_DM1HeartMedications-2-ClinicalData____DM1HeartMedications____Drug", "hm4")
        sel.select(
            "xpath=(//select[@id='id_formset_DM1HeartMedications-2-ClinicalData____DM1HeartMedications____HeartMedicationStatus'])[2]", "label=Previous prescription")
        sel.select(
        ...
        sel.select("id=id_ClinicalData____DM1Fatigue____DM1FatigueInCar",
                   "label=High chance of dozing")
        sel.type(
            "id=id_formset_DM1FatigueMedication-0-ClinicalData____DM1FatigueMedication____DM1FatigueDrug", "fm1")
        sel.select("id=id_formset_DM1FatigueMedication-0-ClinicalData____DM1FatigueMedication____DM1FatigueDrugStatus",
                   "label=Current prescription")
        sel.click("id=add_button_for_section_DM1FatigueMedication")
        sel.type(
            "id=id_formset_DM1FatigueMedication-1-ClinicalData____DM1FatigueMedication____DM1FatigueDrug", "fm2")
        sel.select("id=id_formset_DM1FatigueMedication-1-ClinicalData____DM1FatigueMedication____DM1FatigueDrugStatus",
                   "label=Previous prescription")
        ...
        sel.select(
            "id=id_ClinicalData____DM1SocioeconomicFactors____DM1EmploymentAffected", "label=No")
        sel.select(
            "id=id_ClinicalData____DM1GeneralMedicalFactors____DM1Diabetes", "label=Not diagnosed")
        sel.select(
        ...
        sel.select(
            "id=id_ClinicalData____DM1GeneralMedicalFactors____DM1CognitiveImpairment", "label=No")
        sel.select(
            "id=id_formset_DM1FamilyMembers-0-ClinicalData____DM1FamilyMembers____DM1Sex", "label=Male")
        sel.select(
            "id=id_formset_DM1FamilyMembers-0-ClinicalData____DM1FamilyMembers____DM1Relationship", "label=Parent")
        sel.select(
            "id=id_formset_DM1FamilyMembers-0-ClinicalData____DM1FamilyMembers____DM1FamilyDiagnosis", "label=DM1")
        sel.type(
            "id=id_formset_DM1FamilyMembers-0-ClinicalData____DM1FamilyMembers____DM1FamilyPatientRecord", "1")
        sel.click("id=add_button_for_section_DM1FamilyMembers")
        sel.select(
            "id=id_formset_DM1FamilyMembers-1-ClinicalData____DM1FamilyMembers____DM1Sex", "label=Female")
        sel.select(
            "id=id_formset_DM1FamilyMembers-1-ClinicalData____DM1FamilyMembers____DM1Relationship", "label=Sibling")
        sel.select(
            "id=id_formset_DM1FamilyMembers-1-ClinicalData____DM1FamilyMembers____DM1FamilyDiagnosis", "label=DM2")
        sel.type(
            "id=id_formset_DM1FamilyMembers-1-ClinicalData____DM1FamilyMembers____DM1FamilyPatientRecord", "2")
        sel.click("id=add_button_for_section_DM1FamilyMembers")
        sel.select(
            "id=id_formset_DM1FamilyMembers-2-ClinicalData____DM1FamilyMembers____DM1Sex", "label=Male")
        sel.select(
            "id=id_formset_DM1FamilyMembers-2-ClinicalData____DM1FamilyMembers____DM1Relationship", "label=Child")
        sel.select(
            "id=id_formset_DM1FamilyMembers-2-ClinicalData____DM1FamilyMembers____DM1FamilyDiagnosis", "label=Dont know")
        sel.type(
            "id=id_formset_DM1FamilyMembers-2-ClinicalData____DM1FamilyMembers____DM1FamilyPatientRecord", "3")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-0-ClinicalData____DM1ClinicalTrials____DM1DrugName", "d1")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-0-ClinicalData____DM1ClinicalTrials____DM1TrialName", "t1")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-0-ClinicalData____DM1ClinicalTrials____DM1TrialSponsor", "s2")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-0-ClinicalData____DM1ClinicalTrials____DM1TrialPhase", "p1")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-0-ClinicalData____DM1ClinicalTrials____DM1TrialSponsor", "s1")
        sel.click("id=add_button_for_section_DM1ClinicalTrials")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1DrugName", "d2")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1TrialName", "t2")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1TrialSponsor", "s2")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1TrialPhase", "p2")
        sel.click("xpath=(//button[@type='button'])[16]")
        sel.click("id=add_button_for_section_DM1ClinicalTrials")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1DrugName", "d3")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1TrialName", "t3")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1TrialSponsor", "s3")
        sel.type(
            "id=id_formset_DM1ClinicalTrials-1-ClinicalData____DM1ClinicalTrials____DM1TrialPhase", "p3")
        sel.type(
            "id=id_formset_DM1OtherRegistry-0-ClinicalData____DM1OtherRegistry____DM1OtherRegistry", "r1")
        sel.click("id=add_button_for_section_DM1OtherRegistry")
        sel.type(
            "id=id_formset_DM1OtherRegistry-1-ClinicalData____DM1OtherRegistry____DM1OtherRegistry", "r2")
        sel.click("id=add_button_for_section_DM1OtherRegistry")
        sel.type(
            "id=id_formset_DM1OtherRegistry-2-ClinicalData____DM1OtherRegistry____DM1OtherRegistry", "r3")
        sel.click("id=add_button_for_section_DM1OtherRegistry")
        sel.type(
            "id=id_formset_DM1OtherRegistry-3-ClinicalData____DM1OtherRegistry____DM1OtherRegistry", "r4")
        sel.click("id=add_button_for_section_DM1OtherRegistry")
        sel.type(
            "id=id_formset_DM1OtherRegistry-4-ClinicalData____DM1OtherRegistry____DM1OtherRegistry", "r5")
        sel.click("xpath=(//button[@type='button'])[20]")
        sel.click("id=add_button_for_section_DM1OtherRegistry")
        sel.type(
            "id=id_formset_DM1OtherRegistry-4-ClinicalData____DM1OtherRegistry____DM1OtherRegistry", "r6")
        ...
        try:
            self.assertEqual("mm1", sel.get_value(
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
        try:
            self.assertEqual("mm2", sel.get_value(
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
        try:
            self.assertEqual("mm3", sel.get_value(

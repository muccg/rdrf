...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemographicFields'
        db.create_table(u'rdrf_demographicfields', (
            ...
            ('hidden', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'rdrf', ['DemographicFields'])


    def backwards(self, orm):
        # Deleting model 'DemographicFields'
        db.delete_table(u'rdrf_demographicfields')

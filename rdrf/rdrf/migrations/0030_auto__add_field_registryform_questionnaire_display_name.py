...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistryForm.questionnaire_display_name'
        db.add_column(u'rdrf_registryform', 'questionnaire_display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistryForm.questionnaire_display_name'
        db.delete_column(u'rdrf_registryform', 'questionnaire_display_name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CDEPermittedValue', fields ['code']
        try:
            db.delete_unique(u'rdrf_cdepermittedvalue', ['code'])
        except ValueError:
            pass
        ...
        # Adding unique constraint on 'CDEPermittedValue', fields ['id']
        # the south generated code didnt work so using this
        db.execute("CREATE SEQUENCE rdrf_cdepermittedvalue_id_seq")
        db.execute("SELECT setval('rdrf_cdepermittedvalue_id_seq', 500000)")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsentQuestion.question_label'
        db.alter_column(u'rdrf_consentquestion', 'question_label', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ConsentQuestion.question_label'
        db.alter_column(u'rdrf_consentquestion', 'question_label', self.gf('django.db.models.fields.CharField')(max_length=100))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdjudicationRequest'
        db.create_table(u'rdrf_adjudicationrequest', (
            ...
            ('patient', self.gf('django.db.models.fields.IntegerField')()),
            ('definition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rdrf.AdjudicationDefinition'])),
            ('state', self.gf('django.db.models.fields.CharField')(default='C', max_length=1)),
        ))
        db.send_create_signal(u'rdrf', ['AdjudicationRequest'])

        # Adding model 'AdjudicationDefinition'
        db.create_table(u'rdrf_adjudicationdefinition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('result_fields', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'rdrf', ['AdjudicationDefinition'])

    def backwards(self, orm):
        # Deleting model 'AdjudicationRequest'
        db.delete_table(u'rdrf_adjudicationrequest')

        # Deleting model 'AdjudicationDefinition'
        db.delete_table(u'rdrf_adjudicationdefinition')

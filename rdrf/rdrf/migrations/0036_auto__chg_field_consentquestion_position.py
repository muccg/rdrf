...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsentQuestion.position'
        db.alter_column(u'rdrf_consentquestion', 'position', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ConsentQuestion.position'
        db.alter_column(u'rdrf_consentquestion', 'position', self.gf('django.db.models.fields.IntegerField')(default=1))

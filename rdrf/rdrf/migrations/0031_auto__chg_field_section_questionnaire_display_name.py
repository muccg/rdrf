...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Section.questionnaire_display_name'
        db.alter_column(u'rdrf_section', 'questionnaire_display_name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Section.questionnaire_display_name'
        db.alter_column(u'rdrf_section', 'questionnaire_display_name', self.gf('django.db.models.fields.CharField')(max_length=100))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsentSection.validation_rule'
        db.add_column(u'rdrf_consentsection', 'validation_rule',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsentSection.validation_rule'
        db.delete_column(u'rdrf_consentsection', 'validation_rule')

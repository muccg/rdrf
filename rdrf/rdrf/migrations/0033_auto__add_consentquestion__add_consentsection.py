...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConsentQuestion'
        db.create_table(u'rdrf_consentquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions', to=orm['rdrf.ConsentSection'])),
            ('question_label', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'rdrf', ['ConsentQuestion'])

        # Adding model 'ConsentSection'
        db.create_table(u'rdrf_consentsection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section_label', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('registry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consent_sections', to=orm['rdrf.Registry'])),
            ('information_link', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('applicability_condition', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'rdrf', ['ConsentSection'])


    def backwards(self, orm):
        # Deleting model 'ConsentQuestion'
        db.delete_table(u'rdrf_consentquestion')

        # Deleting model 'ConsentSection'
        db.delete_table(u'rdrf_consentsection')
    ...
    models = {
        ...
        u'rdrf.consentquestion': {
            ...
            'question_label': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'rdrf.consentsection': {
            ...
            'applicability_condition': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsentQuestion.instructions'
        db.add_column(u'rdrf_consentquestion', 'instructions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsentQuestion.instructions'
        db.delete_column(u'rdrf_consentquestion', 'instructions')

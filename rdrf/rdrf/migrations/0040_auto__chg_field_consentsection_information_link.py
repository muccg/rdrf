...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsentSection.information_link'
        db.alter_column(u'rdrf_consentsection', 'information_link', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ConsentSection.information_link'
        db.alter_column(u'rdrf_consentsection', 'information_link', self.gf('django.db.models.fields.CharField')(default='dummy', max_length=100))

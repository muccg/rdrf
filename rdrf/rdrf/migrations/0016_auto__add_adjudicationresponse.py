...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdjudicationResponse'
        db.create_table(u'rdrf_adjudicationresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rdrf.AdjudicationRequest'])),
            ('response_data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'rdrf', ['AdjudicationResponse'])


    def backwards(self, orm):
        # Deleting model 'AdjudicationResponse'
        db.delete_table(u'rdrf_adjudicationresponse')

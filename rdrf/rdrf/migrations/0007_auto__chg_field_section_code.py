...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'rdrf_section', 'code', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Section.code'
        db.alter_column(u'rdrf_section', 'code', self.gf('django.db.models.fields.CharField')(max_length=50))

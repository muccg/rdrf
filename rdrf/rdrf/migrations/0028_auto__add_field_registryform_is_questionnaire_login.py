...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistryForm.is_questionnaire_login'
        db.add_column(u'rdrf_registryform', 'is_questionnaire_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistryForm.is_questionnaire_login'
        db.delete_column(u'rdrf_registryform', 'is_questionnaire_login')

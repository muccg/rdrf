...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsentSection.code'
        db.add_column(u'rdrf_consentsection', 'code',
                      self.gf('django.db.models.fields.CharField')(default=999, max_length=20),
                      keep_default=False)

        # Adding field 'ConsentQuestion.code'
        db.add_column(u'rdrf_consentquestion', 'code',
                      self.gf('django.db.models.fields.CharField')(default=999, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsentSection.code'
        db.delete_column(u'rdrf_consentsection', 'code')

        # Deleting field 'ConsentQuestion.code'
        db.delete_column(u'rdrf_consentquestion', 'code')

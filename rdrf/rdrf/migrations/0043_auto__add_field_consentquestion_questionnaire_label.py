...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsentQuestion.questionnaire_label'
        db.add_column(u'rdrf_consentquestion', 'questionnaire_label',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsentQuestion.questionnaire_label'
        db.delete_column(u'rdrf_consentquestion', 'questionnaire_label')
    ...
    models = {
        ...
        u'rdrf.demographicfields': {
            'Meta': {'object_name': 'DemographicFields'},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CDEPermittedValue.questionnaire_value'
        db.add_column(u'rdrf_cdepermittedvalue', 'questionnaire_value',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CDEPermittedValue.questionnaire_value'
        db.delete_column(u'rdrf_cdepermittedvalue', 'questionnaire_value')

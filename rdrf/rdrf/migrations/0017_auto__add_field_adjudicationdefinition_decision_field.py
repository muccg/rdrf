...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdjudicationDefinition.decision_field'
        db.add_column(u'rdrf_adjudicationdefinition', 'decision_field',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdjudicationDefinition.decision_field'
        db.delete_column(u'rdrf_adjudicationdefinition', 'decision_field')

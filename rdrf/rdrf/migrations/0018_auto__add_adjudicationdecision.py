...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdjudicationDecision'
        db.create_table(u'rdrf_adjudicationdecision', (
            ...
            ('decision_data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'rdrf', ['AdjudicationDecision'])


    def backwards(self, orm):
        # Deleting model 'AdjudicationDecision'
        db.delete_table(u'rdrf_adjudicationdecision')

...
class SetupView(tfv.core.SetupView):
    ...
    def get_context_data(self, form, **kwargs):
        ...
        context['popup_text'] = '''
        A new security feature, two factor authentication, is now available. If enabled, in addition to your password, you will be required to provide a verification code in order to log in.
        <br>
        You may already be familiar with this security feature, as it is already used on many online banking websites, and by major email providers.
        <br>
        When you log into the Registry, you already use a password to verify your identity. If you choose to enable two-factor authentication, you will be asked to provide another verification code in order to
log in.
        <br>
        Enabling two factor authentication is not required, but it is highly recommended.
        <br>
        You will need a smartphone with an authenticator app such as 'Google Authenticator'. This particular app is available on both Android and iOS mobile devices.
        <br>
        If two-factor authentication is enabled, you will be asked for your username and password, and then you will be asked to enter the token generated by your token generator. Open your authenticator app (such as Google Authenticator), and enter the token. You will then be logged into the Registry.
        <br>
        Click 'Next' to progress through the wizard to enable two factor authentication.
        '''
        return context

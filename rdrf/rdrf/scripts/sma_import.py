...
DATA_MAP = {"field_expression111": {"field": "ip_group",
            ...
            "ClinicalDiagnoses/SMAClinicalDiagnosis/DMDMuscleBiopsy": {"field": "muscle_biopsy",
                                                                       "model": "dmd.diagnosis",
                                                                       "converter": Conv.YNU},
            ...
            ##########    SMA   ########################
            "ClinicalDiagnoses/SMAClinicalDiagnosis/SMADiagnosis": {"field": "diagnosis",
                                                                    "model": "sma.diagnosis",
                                                                    "converter": {
                                                                        "SMA": "SMASMA",
                                                                        "Unk": "SMAUnk",
            ...
            "field_expression143": {"field": "diagnosis",
                                    "model": "dmd.clinicaltrials"},
            "ClinicalDiagnoses/DMDHeart/DMDlvef": {"field": "lvef",
                                                   "model": "dmd.heart"},
            "ClinicalDiagnoses/DMDHeart/DMDHeartPrevious": {"field": "failure",
                                                            "model": "dmd.heart",
                                                            "converter": Conv.YNU},
            "field_expression123": {"field": "diagnosis",
                                    "model": "dmd.steroids"},
            "ClinicalDiagnoses/DMDSteroids/DMDSteroidCurrent": {"field": "current",
                                                                "model": "dmd.steroids",
                                                                "converter": Conv.YNU},
            "ClinicalDiagnoses/DMDMotorFunction/NMDSit": {"field": "sit",
                                                          "model": "dmd.motorfunction"},
            "field_expression120": {"field": "diagnosis",
                                    "model": "dmd.motorfunction"},
            "ClinicalDiagnoses/DMDHeart/DMDHeartCurrent": {"field": "current",
                                                           "model": "dmd.heart",
                                                           "converter": Conv.YNU},
            ...
            "ClinicalDiagnoses/NMDSurgery/NMDSurgery": {"field": "surgery",
                                                        "model": "dmd.surgery",
                                                        "converter": Conv.YNU},
            "ClinicalDiagnoses/DMDSteroids/DMDSteroidPrevious": {"field": "previous",
                                                                 "model": "dmd.steroids"},
            ...
            "field_expression130": {"field": "diagnosis",
                                    "model": "dmd.heart"},
            "ClinicalDiagnoses/DMDHeart/DMDlvefDate": {"field": "lvef_date",
                                                       "model": "dmd.heart"},
            ...
            "field_expression99": {"field": "object_id_int",
                                   "model": "reversion.version"},
            "ClinicalDiagnoses/DMDMotorFunction/NMDWheelchairChoices": {"field": "wheelchair_use",
                                                                        "model": "dmd.motorfunction"},
            "ClinicalDiagnoses/DMDMotorFunction/NMDWalk": {"field": "walk",
                                                           "model": "dmd.motorfunction"},

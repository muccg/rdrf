...
def patient_questionnaire_access(function):
    ...
    def _wrapped_view(*args, **kwargs):
        ...
        # If questionnaire is protected, then the user must be in
        # patients group and logged in. If not, redirect to the
        # patient view. Note that that patient_page url does not exist
        # in base rdrf.

...
elif settings.SYSTEM_ROLE == SystemRoles.CIC_DEV:
    urlpatterns = proms_site + normalpatterns
elif settings.SYSTEM_ROLE == SystemRoles.NORMAL:
    urlpatterns = report_urls + normalpatterns
else:

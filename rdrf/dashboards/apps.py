...
all_configs = VisualisationConfig.objects.filter(registry=registry,dashboard="A").order_by("position")
single_configs = VisualisationConfig.objects.filter(registry=registry,dashboard="S").order_by("position")

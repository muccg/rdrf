...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('genetic_variationsma', (
        ...
        db.create_table('genetic_moleculardatasma', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('genetic_variationsma')

        # Deleting model 'MolecularDataSma'
        db.delete_table('genetic_moleculardatasma')
    ...
    models = {
        ...
        'genetic.moleculardatasma': {
            'Meta': {'ordering': "['patient']", 'object_name': 'MolecularDataSma'},
            'patient': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['patients.Patient']", 'unique': 'True', 'primary_key': 'True'})
        },
        'genetic.variation': {
        ...
        'genetic.variationsma': {
            'Meta': {'object_name': 'VariationSma'},
            'dna_variation': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'exon_7_sequencing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'exon_7_smn1_deletion': ('django.db.models.fields.IntegerField', [], {}),
            'gene': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['genetic.Gene']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'molecular_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['genetic.MolecularDataSma']"}),
            'technique': ('django.db.models.fields.TextField', [], {})
        },
        'groups.workinggroup': {
